    ...
    <div className="animate-pulse">
      ...
      <div className="max-w-7xl mx-auto mt-36 px-4 md:px-8 lg:px-12 grid grid-cols-1 md:grid-cols-[1fr_250px] gap-8">
        ...
        <div className="flex flex-col gap-6">
          <div className="relative bg-white/90 backdrop-blur-md rounded-3xl shadow-xl p-6">
            {/* Title */}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              ...
              <div className="h-44 w-full bg-gray-300 rounded-xl hidden sm:block"></div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="h-4 w-9/12 bg-gray-300 rounded"></div>
        ...
        {/* Author Sidebar Skeleton (only if includeAuthor=true) */}
        {includeAuthor && (
