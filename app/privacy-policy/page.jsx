...
const PrivacyPolicyPage = () => {
  ...
  <p className="text-gray-800 text-lg sm:text-xl leading-relaxed">
    At <span className="font-semibold text-orange-500">SRBlogs</span>, your data is <span className="text-orange-500 font-medium">fully secure</span>.
  </p>
  <p className="text-gray-700 text-lg sm:text-xl leading-relaxed">
    Only the <span className="text-orange-500 font-medium">writer</span> who created a blog or an <span className="text-orange-500 font-medium">admin</span> can modify it, ensuring full control.
  </p>
  <p className="text-gray-700 text-lg sm:text-xl leading-relaxed">
    Authentication is powered by <span className="text-orange-500 font-medium">Clerk</span>, keeping your account safe and reliable.
  </p>
</div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
        {points.map((point, index) => (
          ...
          >
            {point.icon}
            <h3 className="text-xl font-semibold mt-4 mb-2 text-gray-800">{point.title}</h3>
